                ...
                <el-tabs type='border-card' @tab-click='tabClick'>
                    <el-tab-pane label='Swap' style='flex: 1'>
                        <div class='tab_div'>
                            <el-input v-model='swapInput' style='width: 80%' @input='setOutputAmount' type='number' min='0' placeholder='0.0'>
                                ...
                                <Dropdown v-model='swapInputDropdown' style='width: 100px' slot='append' :itemData='data' :change='changeInput' />
                            </el-input>
                        </div>
                        <div class='tab_div'>
                            <el-input v-model='swapOutput' style='width: 80%' @input='setInputAmount' type='number' min='0' placeholder='0.0'>
                                ...
                                <Dropdown v-model='swapOutputDropdown' style='width: 100px' slot='append' :itemData='data' :change='changeOutput' />
                            </el-input>
                        </div>
                    ...
                    <el-tab-pane label='Send' style='flex: 1'>
                        ...
                        <div class='tab_div'>
                            <el-input v-model='swapOutput' style='width: 80%' @input='setInputAmount' type='number' min='0' placeholder='0.0'>
                                <div slot='prepend' style='width: 50px'>Output</div>
                                <Dropdown style='width: 100px' slot='append' :itemData='data' :change='changeOutput' v-model='swapOutputDropdown' />
                            </el-input>
                        </div>
                        <div class='tab_div'>
                                ...
                                <el-tab-pane label='Add Liquidity'>
                                    ...
                                    <div class='tab_div'>
                                        <el-input v-model='poolTokenAmt' style='width: 80%' type='number' min='0' placeholder='0.0'>
                                            <Dropdown style='width: 100px' slot='append' :itemData='filterData' :change='computeAddLiquidity' v-model='poolTokenDropdown' />
                                        </el-input>
                                    </div>
                                </el-tab-pane>
                                <el-tab-pane label='Remove Liquidity'>
                                    <div class='tab_div'>
                                        <el-input v-model='poolLiquidityAmt' @input='removeLiquidityInput' style='width: 80%' type='number' min='0' placeholder='0.0'>
                                            <Dropdown style='width: 120px' slot='append' :itemData='poolLiquidity' :change='computeRemoveLiquidity' v-model='poolLiquidityDropdown' />
                                        </el-input>
                                    </div>
                                    <div class='tab_div'>
                                        <el-input disabled v-model='poolLiquidityOutput' style='width: 80%' placeholder='Withdraw Token' />
                                    </div>
                                </el-tab-pane>
                            </el-tabs>
                        </div>
